...
export const fetchMovies = createAsyncThunk(
    'movies/fetchMovies',
    async () => {
        const response = await API.get('/moviess')
...
export const fetchMovieById = createAsyncThunk(
    ...
    async (id) => {
        const response = await API.get('/moviess/' + id)
        return response.data
    }
)
...
export const createMovie = createAsyncThunk(
    'movies/createMovie',
    async (newMovie) => {
        const response = await API.post('/moviess', newMovie)
        return response.data
    }
)
...
export const deleteMovie = createAsyncThunk(
    ...
    async (id) => {
        ...
        const response = await API.delete(`/moviess/${id}`)
        return response.data
    }
)
...
export const updateMovie = createAsyncThunk(
    'movies/updateMovie',
    async (updatedMovie) => {
        const response = await API.put('/moviess/' + updatedMovie.id, updatedMovie)
        return response.data
    }
)
